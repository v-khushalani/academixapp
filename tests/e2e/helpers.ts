...
export const DEMO = {
  admin: { email: "admin@academix.website", loginPath: "/login", home: "/app" },
  teacher: { email: "teacher@academix.website", loginPath: "/login", home: "/teach" },
  student: { email: "student@academix.website", loginPath: "/login", home: "/portal" },
} as const;
