      ...
      <table className="w-full table-fixed border-collapse">
        <thead>
          <tr className="bg-muted/60">
            <th className="w-[84px] px-2 py-2 text-left text-[10px] font-semibold uppercase tracking-wider text-muted-foreground">
              Period
            </th>
            {columns.map((c) => (
          ...
          {bands.map((b, i) => (
            <tr key={b.start} className="border-t border-border">
              <th className="px-2 py-1.5 text-left align-top">
                <p className="text-[11px] font-semibold">P{i + 1}</p>
